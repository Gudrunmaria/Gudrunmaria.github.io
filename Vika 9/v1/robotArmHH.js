...
var UPPERUPPER_ARM_HEIGHT=3.0;
var UPPERUPPER_ARM_WIDTH =0.5;
    ...
    // Event listener for keyboard
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 67:	// q - snýr efri armi
			    theta[3] = Math.min(170, theta[3]+5);
                break;
            case 86:	// w - snýr efri armi
...
function upperupperArm(){
    var s = scalem(UPPERUPPER_ARM_WIDTH, UPPERUPPER_ARM_HEIGHT,UPPERUPPER_ARM_WIDTH);
    var instanceMatrix =mult(translate(0.0,0.5 * UPPERUPPER_ARM_HEIGHT,0.0), s)
    var t = mult(modelViewMatrix,instanceMatrix);
    gl.uniformMatrix4fv(modelViewMatrixLoc,false, flatten(t));
    gl.drawArrays(gl.TRIANGLES,0,NumVertices);
}
